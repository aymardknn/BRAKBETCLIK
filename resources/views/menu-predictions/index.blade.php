...
<div class="table-container px-4 sm:overflow-x-auto ">
    ...
    <h3 class="text-lg font-semibold text-center text-gray-800 mt-6 mb-4">Argentina : Liga Profesinal Argentina </h3>
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            <thead>
                <tr class="bg-gray-100 border-b">
            ...
            <tbody>
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>22:00</strong></h6>Argentinos Juniors - Central Cordoba</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.48</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <!--
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:00</strong></h6>Vaasa - Inter Turku</td>
        ...
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <tbody>
                <tr class="border-b hover:bg-gray-100">
                    ...
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">GG</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.45</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <!-- Ajoutez d'autres lignes de tableau ici -->
            </tbody>
    ...
    <h3 class="text-lg font-semibold text-center text-gray-800 mt-6 mb-4">Ireland : Premier Division</h3>
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            <thead>
                <tr class="bg-gray-100 border-b">
            ...
            <tbody>
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:45</strong></h6>Bohemians - Derry City</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">+1.5</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.36</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:45</strong></h6>Dundalk - Sligo Rovers City</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1X</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.28</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:45</strong></h6>Galway - Drogheda</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.68</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <tr class="border-b hover:bg-gray-100">
                ...
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:45</strong></h6>Wateford - Shelbourne</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">X2</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.38</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
                <tr class="border-b hover:bg-gray-100">
                ...
                <tr class="border-b hover:bg-gray-100">
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center"><h6><strong>18:45</strong></h6>Cork City - Cobh Ramblers</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">1.38</td>
                    <td class="px-4 sm:py-3 sm:text-sm py-2 text-sm text-gray-700 text-center">?</td>
                </tr>
